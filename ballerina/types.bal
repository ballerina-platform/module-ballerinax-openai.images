...
public type ModifyThreadRequestToolResourcesCodeInterpreter record {
...
public type CreateThreadAndRunRequestToolResourcesFileSearch record {
...
public type CreateThreadAndRunRequestToolResourcesCodeInterpreter record {
    # A list of [file](/docs/api-reference/files) IDs made available to the `code_interpreter` tool. There can be a maximum of 20 files associated with the tool
    @jsondata:Name {value: "file_ids"}
    string[] fileIds = [];
};
...
public type ModifyAssistantRequestTools AssistantToolsCode|AssistantToolsFileSearch|AssistantToolsFunction;
...
public type CreateThreadRequestToolResourcesCodeInterpreter record {
    # A list of [file](/docs/api-reference/files) IDs made available to the `code_interpreter` tool. There can be a maximum of 20 files associated with the tool
    @jsondata:Name {value: "file_ids"}
    string[] fileIds = [];
};
...
public type FineTuningIntegrationWandb record {
...
public type CreateAssistantRequestTools AssistantToolsCode|AssistantToolsFileSearch|AssistantToolsFunction;
...
public type CreateRunRequestTools AssistantToolsCode|AssistantToolsFileSearch|AssistantToolsFunction;
...
public type RunObjectTools AssistantToolsCode|AssistantToolsFileSearch|AssistantToolsFunction;
...
public type ThreadObjectToolResourcesCodeInterpreter record {
    # A list of [file](/docs/api-reference/files) IDs made available to the `code_interpreter` tool. There can be a maximum of 20 files associated with the tool
    @jsondata:Name {value: "file_ids"}
    string[] fileIds = [];
};
